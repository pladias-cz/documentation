...
3) cleanup & truncate table:
    ...
    ```
4) upload occurrences from Simple on megastroj, import records.csv via admin.pladias.cz Console ``` docker exec management_php bin/console gbif:importRecords  docker exec adminpladiascz-app-1 bin/console gbif:importRecords```
